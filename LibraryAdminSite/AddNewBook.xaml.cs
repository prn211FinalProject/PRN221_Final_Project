        ...
        private void btnAdd_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                var newBook = new Book
                {
                    ...
                    Cid = cmbGenre.SelectedIndex , // Điều chỉnh theo ID thực tế nếu có
                    PublisherId = cbxNXB.SelectedIndex , // Điều chỉnh theo ID thực tế nếu có
                    ...
                    Price = decimal.Parse(txtPrice.Text)// Giá mặc định, điều chỉnh theo nhu cầu
                };
